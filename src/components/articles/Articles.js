...
//         const URL = `http://api.mediastack.com/v1/news?access_key=98dc895c193ccd95ea40c83349780be8&languages=en&sort=published_desc&offset=${this.state.currentPage}&keywords=${this.state.query}`;
...
//                     console.log(body);
//                     this.setState({
//                         hits: [...body.data], pageCount: body.pagination.total, isLoaded: true
//                     })
//                 })
